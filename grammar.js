...
(function () {
  ...
  var grammar = {
    ...
    ParserRules: [
      ...
      { "name": "andExpr$ebnf$1$subexpression$1", "symbols": ["__", (lexer.has("AND") ? { type: "AND" } : AND), "__", "atomicExpr"] },
      { "name": "andExpr$ebnf$1", "symbols": ["andExpr$ebnf$1$subexpression$1"] },
      { "name": "andExpr$ebnf$1$subexpression$2", "symbols": ["__", (lexer.has("AND") ? { type: "AND" } : AND), "__", "atomicExpr"] },
      { "name": "andExpr$ebnf$1", "symbols": ["andExpr$ebnf$1", "andExpr$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) { return d[0].concat([d[1]]); } },
      { "name": "andExpr", "symbols": ["atomicExpr", "andExpr$ebnf$1"], "postprocess": ([first, rest]) => ['+' + first, ...rest.map(([, , , item]) => '+' + item)].join(' ') },
      { "name": "orExpr$ebnf$1$subexpression$1", "symbols": ["__", (lexer.has("OR") ? { type: "OR" } : OR), "__", "atomicExpr"] },
      { "name": "orExpr$ebnf$1", "symbols": ["orExpr$ebnf$1$subexpression$1"] },
      { "name": "orExpr$ebnf$1$subexpression$2", "symbols": ["__", (lexer.has("OR") ? { type: "OR" } : OR), "__", "atomicExpr"] },
      { "name": "orExpr$ebnf$1", "symbols": ["orExpr$ebnf$1", "orExpr$ebnf$1$subexpression$2"], "postprocess": function arrpush(d) { return d[0].concat([d[1]]); } },
      { "name": "orExpr", "symbols": ["atomicExpr", "orExpr$ebnf$1"], "postprocess": ([first, rest]) => [first, ...rest.map(([, , , item]) => item)].join(' ') },
      { "name": "notExpr", "symbols": [(lexer.has("NOT") ? { type: "NOT" } : NOT), "__", "expr"], "postprocess": ([not, , d]) => { return `-${d}` } },
      { "name": "atomicExpr", "symbols": ["wordSeq"], "postprocess": id },
      { "name": "atomicExpr", "symbols": [(lexer.has("quote") ? { type: "quote" } : quote)], "postprocess": d => d[0].text },
